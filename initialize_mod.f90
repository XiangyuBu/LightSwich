...
DOUBLE PRECISION :: ratio_sigma, a_plane,loa_azo, r_hole
...
read(10,*) azo_position_1    ! azo position / L from the free end
read(10,*) azo_position_2
...
read(10,*) r_hole          ! radius of the hole
...
do while(x_flag == 1)
    ...
    do while(x_flag == 1)
        ...
        do while(temp_1 <= (r_hole*r_sphere)**2)            
...
!!!!!!!!!!There are two model in this module!!!!!!!
...
do i = (n_azo/2)+1,n_azo
    write(45,*) graft_point(i-n_azo/2+1)%x, graft_point(i-n_azo/2+1)%y, -(graft_point(i-n_azo/2+1)%z)
end do 
close(45)
